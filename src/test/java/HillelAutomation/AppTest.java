...
public class AppTest {
    ...
    public static void generateNumber(Integer min, Integer max, Integer total, Double threshold) throws InterruptedException {
        ...
        clearAndFill(By.cssSelector("input[name=max]"), max.toString())
            .submit();
        ...
        Assert.assertTrue(
            Collections.max(numberCounter.values()) - Collections.min(numberCounter.values())
            <= (total / 100 * threshold));
